...
public class ViewBabyNameBySex extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print(" <a href='ViewBabyNameBySex?sex=girl&religion=christian' class='btn btn-primary' role='button'>ChristianBabyGirl</a> ");
		//out.print(" <a href='ViewBabyNameBySex?sex=girl' class='btn btn-primary' role='button'>BabyGirl</a> ");
		request.getRequestDispatcher("atoz.html").include(request, response);
		
		out.println("<h1>View Baby  "+sex.toUpperCase()+"</h1>");
		List<Baby> list=BabyDao.getRecordsBySex(sex,religion);
